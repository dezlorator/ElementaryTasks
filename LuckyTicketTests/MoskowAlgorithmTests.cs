...
{
    public class MoskowAlgorithmTests : IClassFixture<MoskowAlgorithm>
    {
        ...
        public void MoskowAlgorithm_WithArrayOfTickets_ShouldReturnTrue(string[] ticketsArray, int expected)
        {
